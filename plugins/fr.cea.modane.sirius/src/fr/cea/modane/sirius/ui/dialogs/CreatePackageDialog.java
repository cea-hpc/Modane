...
public class CreatePackageDialog extends TitleAreaDialog {
	...
	private CreatePackageData data;
	 ...
	 * @param parentShell
	 */
	public CreatePackageDialog(Shell parentShell) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		setMessage("Creates a new package and its model");
		...
		Label lblCreateModanemodel = new Label(container, SWT.NONE);
		lblCreateModanemodel.setText("Create model:");
	...
	private void initContents() {
		data = new CreatePackageData("", true);
	}

	public CreatePackageData getData() {
		return data;
	}
	...
	protected DataBindingContext initDataBindings() {
		...
		IObservableValue packageNameDataObserveValue = PojoProperties.value("packageName").observe(data);
		...
		IObservableValue createModaneModelDataObserveValue = PojoProperties.value("createModaneModel").observe(data);
