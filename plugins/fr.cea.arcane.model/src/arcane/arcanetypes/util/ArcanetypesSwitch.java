 ...
 * $Id$
 */
package arcane.arcanetypes.util;
 ...
 * @generated
 */
public class ArcanetypesSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static ArcanetypesPackage modelPackage;
	 ...
	 * @generated
	 */
	public ArcanetypesSwitch() {
		if (modelPackage == null) {
			modelPackage = ArcanetypesPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ArcanetypesPackage.ARCANE_TYPES: {
				ArcaneTypes arcaneTypes = (ArcaneTypes)theEObject;
				T result = caseArcaneTypes(arcaneTypes);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArcanetypesPackage.ITEM_TYPE: {
				ItemType itemType = (ItemType)theEObject;
				T result = caseItemType(itemType);
				if (result == null) result = caseMeshType(itemType);
				if (result == null) result = casePropertyOrArgumentType(itemType);
				if (result == null) result = caseNamedElement(itemType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArcanetypesPackage.SIMPLE_TYPE: {
				SimpleType simpleType = (SimpleType)theEObject;
				T result = caseSimpleType(simpleType);
				if (result == null) result = casePropertyOrArgumentType(simpleType);
				if (result == null) result = caseNamedElement(simpleType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ArcanetypesPackage.MESH_TYPE: {
				MeshType meshType = (MeshType)theEObject;
				T result = caseMeshType(meshType);
				if (result == null) result = casePropertyOrArgumentType(meshType);
				if (result == null) result = caseNamedElement(meshType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Arcane Types</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Arcane Types</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseArcaneTypes(ArcaneTypes object) {
		return null;
	}
