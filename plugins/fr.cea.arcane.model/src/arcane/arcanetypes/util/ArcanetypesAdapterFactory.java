 ...
 * @generated
 */
public class ArcanetypesAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	public ArcanetypesAdapterFactory() {
	 ...
	 * @generated
	 */
	protected ArcanetypesSwitch<Adapter> modelSwitch =
		new ArcanetypesSwitch<Adapter>() {
			@Override
			public Adapter caseArcaneTypes(ArcaneTypes object) {
				return createArcaneTypesAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link arcane.arcanetypes.ArcaneTypes <em>Arcane Types</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createArcaneTypesAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link arcane.arcanetypes.ItemType <em>Item Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link arcane.arcanetypes.SimpleType <em>Simple Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link arcane.arcanetypes.MeshType <em>Mesh Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
