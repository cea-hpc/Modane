...
public class StructTestCase extends TestCaseBase
{
	private final static String Dir = "Struct";
	...
	{
		testGenerationAndCompilationFromUmlModel(Dir);
		assertEquals(0, run("./build/Calculator -arcane_opt max_iteration 1 ./Calculator.arc", Dir));
	}
