#ifndef SUPPORT_EOS___PERFECTGASCOMPUTEBYITEMTYPE_H
#define SUPPORT_EOS___PERFECTGASCOMPUTEBYITEMTYPE_H
...
template <class T>
class PerfectGasComputeByItemType
: public AbstractItemOperationByBasicType
{
  public:
    explicit PerfectGasComputeByItemType(T* srv, PerfectGasComputeByItemTypeVars& vars, const Real coef)
	: m_srv(srv)
	, m_vars(vars)
	, m_coef(coef)
	{
	}
    ~PerfectGasComputeByItemType() {};
  ...
  private:
    T* m_srv;
    PerfectGasComputeByItemTypeVars m_vars;
    const Real m_coef;
};
...
#endif  // SUPPORT_EOS___PERFECTGASCOMPUTEBYITEMTYPE_H
