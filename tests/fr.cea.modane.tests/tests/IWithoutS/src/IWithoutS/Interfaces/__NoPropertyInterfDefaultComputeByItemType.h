#ifndef IWITHOUTS_INTERFACES___NOPROPERTYINTERFDEFAULTCOMPUTEBYITEMTYPE_H
#define IWITHOUTS_INTERFACES___NOPROPERTYINTERFDEFAULTCOMPUTEBYITEMTYPE_H
...
template <class T>
class NoPropertyInterfDefaultComputeByItemType
: public AbstractItemOperationByBasicType
{
  public:
    explicit NoPropertyInterfDefaultComputeByItemType(T* srv, NoPropertyInterfDefaultComputeByItemTypeVars& vars, const Real coef)
	: m_srv(srv)
	, m_vars(vars)
	, m_coef(coef)
	{
	}
    ~NoPropertyInterfDefaultComputeByItemType() {};
  ...
  private:
    T* m_srv;
    NoPropertyInterfDefaultComputeByItemTypeVars m_vars;
    const Real m_coef;
};
...
#endif  // IWITHOUTS_INTERFACES___NOPROPERTYINTERFDEFAULTCOMPUTEBYITEMTYPE_H
