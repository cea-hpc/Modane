#ifndef IWITHOUTS_INTERFACES___NOPROPERTYINTERFVIASTRUCTDEFAULTCOMPUTEBYITEMTYPE_H
#define IWITHOUTS_INTERFACES___NOPROPERTYINTERFVIASTRUCTDEFAULTCOMPUTEBYITEMTYPE_H
...
template <class T>
class NoPropertyInterfViaStructDefaultComputeByItemType
: public AbstractItemOperationByBasicType
{
  public:
    explicit NoPropertyInterfViaStructDefaultComputeByItemType(T* srv, NoPropertyInterfViaStructDefaultComputeByItemTypeVars& vars, const Real coef)
	: m_srv(srv)
	, m_vars(vars)
	, m_coef(coef)
	{
	}
    ~NoPropertyInterfViaStructDefaultComputeByItemType() {};
  ...
  private:
    T* m_srv;
    NoPropertyInterfViaStructDefaultComputeByItemTypeVars m_vars;
    const Real m_coef;
};
...
#endif  // IWITHOUTS_INTERFACES___NOPROPERTYINTERFVIASTRUCTDEFAULTCOMPUTEBYITEMTYPE_H
