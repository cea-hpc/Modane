#ifndef MICROHYDRO_EOS___PERFECTGASSERVICEVARS_H
#define MICROHYDRO_EOS___PERFECTGASSERVICEVARS_H
...
{
  PerfectGasInitEOSVars(const VariableCellReal& adiabatic_cst,
...
{
  PerfectGasApplyEOSVars(const VariableCellReal& internal_energy,
      const VariableCellReal& density,
...
#endif  // MICROHYDRO_EOS___PERFECTGASSERVICEVARS_H
