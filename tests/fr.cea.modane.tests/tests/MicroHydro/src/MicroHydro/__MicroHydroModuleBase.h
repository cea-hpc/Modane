...
: public ArcaneMicroHydroObject
{
   ...
   \dot
     digraph applyEquationOfStateGraph
     {
       ...
       subgraph clusterCalledFuncs
       {
         ...
         ILoopDelegation_computeInternalEnergy [label="computeInternalEnergy", color="navy", fontcolor="navy", style="rounded", URL="\ref MicroHydro::ILoopDelegation::computeInternalEnergy"];
       }
       applyEquationOfState -> ILoopDelegation_computeInternalEnergy [lhead="clusterCalledFuncs", style="dashed", label=" call"];
     }
   \enddot
  ...
  */
  ...
  {
    MicroHydroApplyEquationOfStateVars vars;
